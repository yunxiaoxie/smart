    ...
    return {
      ...
      template: function(el, attrs){
        ...
        if (type && type.indexOf('select') !== -1) {
          return require('../views/widgets/qk-select.html');
        } else if (type && type.indexOf('radio') !== -1) {
          return require('../views/widgets/qk-radio.html');
        } else if (type && type.indexOf('checkbox') !== -1) {
          return require('../views/widgets/qk-checkbox.html');
        } else if (type && type.indexOf('date') !== -1) {
          return require('../views/widgets/qk-date-picker.html');
        } else {
    ...
    return {
        ...
        link: function($scope, element, attrs, ngModel) {
            ...
            UtilsService.querySync('/dataDic/1006').then(function (data) {
                if (data) {
                    $.fn.zTree.init($(element[0]), setting, data.data);
                } else {
